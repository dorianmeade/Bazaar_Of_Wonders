...
from main.models import Card, Card_Type, Card_Rarity, Listing, Seller
...
class HomePageTest(TestCase): #view or template??
    def setUp(self):
        ...
        #seller obj
        seller_inst = Seller.objects.create(seller_key='123abc', seller_name='sellerTest', seller_type='good', completed_sales=0)
        #listing obj
